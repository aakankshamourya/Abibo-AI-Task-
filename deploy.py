...
@app.route('/ask-chatbot-dev-nexus-aspire')
def upload():
    ...
    try:
        ...
        if request.method == "POST":
            ...
            return jsonify({"errorCode": "ds-201",
                    "message": "There was some error in uploading the files and processing them. Please try again after some time. If the issue persists, please contact the ASK chatbot-dev-nexus support team at [chatbot-dev-nexus.support@nexus.com]. They will be happy to assist you further.",
...
def clear_database():
    try:
        ...
        return({"errorCode": "ds-203",
            "message": "Sorry, we could not delete the files. Please contact our support team at chatbot-dev-nexus.support@nexus.com.",
            "AN-CorrelationID": correlation_id}), 999
...
if __name__ == '__main__':
    ...
    app.run(host=ip_address, port=DEPLOY_PORT, debug=True)
